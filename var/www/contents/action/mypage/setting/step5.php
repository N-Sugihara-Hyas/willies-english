...
*/
		...
		$arrayCourceSchedule = $this->TakeReserve->getDataTime($arrayData['cID'], $arrayDate, $arrayData['time'], $arrayCourceStyle['weekTime'], 1, '', $arrayData['cshID']);
		...
		$this->set('weekTime', $arrayCourceStyle['weekTime']);
