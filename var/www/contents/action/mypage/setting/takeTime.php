...
*/
		...
		//モデル情報の読み込み
		$this->addModel(array('cource/Style', 'member/Setting', 'setting/Meta', 'take/Schedule', 'take/Reserve', 'take/Base'));
		...
		$arrayCourceSchedule = $this->TakeReserve->getDataDate($arrayData['cID'], $arrayDate, $arrayCourceStyle['weekTime'], 1, $this->arrayAll['tID']);
