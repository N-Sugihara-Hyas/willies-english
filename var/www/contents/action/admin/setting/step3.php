...
*/
		...
		if (!$arrayData = $this->MemberSetting->getSettingStep(2, $this->arrayAll) ){
			$this->setRedirect('setting/step2/?error=1');
		}
		...
		if (!$arrayCourceStyle['weekTake']){
			$this->setRedirect('setting/step2_1/?cource_style_id=' . $this->arrayAll['cource_style_id']);
		}
		...
		$this->set('arraySchdule', $this->SettingMeta->getDataSchedule($arrayData['csID']));
