...
*/
		...
		$this->$modelName->target = '*,take_feedback.*';
		...
		//カードレビューと昔のフィードバックがごちゃまぜになってる。
		$this->set('arrayCardReview', $this->$modelName->getFunctionData('CardReview'));
		$this->set('arrayFeedLevel', $this->$modelName->getFunctionData('FeedLevel'));
